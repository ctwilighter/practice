...
$sql="select * from article,article_cate where article.cateid=article_cate.cateid order by artiid desc limit {$offset},{$pageSize}";
//echo $sql;
$rows=fetchAll($sql);
if(!$rows){
...
$sql="select * from article,article_cate where article.cateid=article_cate.cateid";
$news=fetchAll($sql);
?>
