...
<div class="pagination"><div class="pre"><a href="__APP__/Article/up/id/<?php echo ($news['id']); ?>">上一篇</a></div><div class="next"><a href="__APP__/Article/down/id/<?php echo ($news['id']); ?>">下一篇</div></a></div>
