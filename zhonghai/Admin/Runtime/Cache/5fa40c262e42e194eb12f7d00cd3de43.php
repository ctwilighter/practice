                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                    ...
                    <tbody>
                        <?php if(is_array($server)): $i = 0; $__LIST__ = $server;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><img src="<?php echo ($vo['image']); ?>" style="height: 60px;"></td>
								<td><a class="btn btn_orange btn_flag" href="__APP__/Server/edit/id/<?php echo ($vo['id']); ?>"><span>修改</span></a>&nbsp;&nbsp;<a class="btn btn_orange btn_trash" href="__APP__/Server/del/id/<?php echo ($vo['id']); ?>"><span>删除</span></a></td>
