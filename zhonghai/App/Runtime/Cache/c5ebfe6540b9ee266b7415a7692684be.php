...
<!--end动画-->
<!--star一行-->
<div class="w_1200 news_detail">
<div class="title"><img src="<?php echo IMG_URL;?>edit.png">操作人员</div>
<div class="content">
	<?php echo (htmlspecialchars_decode($news['content'])); ?>
	<p class="date"><?php echo date("Y年m月d日",$news['time']);?></p>
</div>
<div class="pagination"><div class="pre"><a href="<?php echo U('Article/news_detail',array('id'=>$news['id'],'up'=>1));?>">上一篇</a></div><div class="next"><a href="<?php echo U('Article/news_detail',array('id'=>$news['id'],'down'=>1));?>">下一篇</div></a></div>
