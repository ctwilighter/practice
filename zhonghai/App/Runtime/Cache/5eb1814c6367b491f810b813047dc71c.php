...
<div class="tnav" id="slideNav">
	<div class="tnav tnav02 w_1200">
		<ul class="tnavlist">
			...
			<li class="current_nav"><a href="<?php echo U('Cases/cases');?>" class="dt">成功案例</a></li>
...
<div class="w_1200">
<div class="page_04">
	<div class="title">成功案例<div></div></div>
	<div class="nav"><a href="index.html">首页</a>/<span>成功案例</span></div>
	</div>
	<div class="service_project">
		<div class="content">
			<?php if(is_array($cases)): $i = 0; $__LIST__ = $cases;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item"><a href="####"><img src="<?php echo ($vo['image']); ?>" alt=""></a><p><?php echo ($vo['title']); ?></p></div><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
		<div class="clear"></div>
	</div>
